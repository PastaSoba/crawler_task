...
class Luca:
    baseurl = "https://www.iqon.jp/store_locator/brand/Luca/4162/"
    ...
    def _AppendItemToDataFrame(storeName: str, storeAddress: str):
        ...
        tmp_se = pd.Series([storeName, storeAddress],
                           index=Luca._result_df.columns)
        Luca._result_df = Luca._result_df.append(
    ...
    def miniworker(*args):
        ...
        *args[3] (storeName:str)
        ...
        page = Luca._OpenURLWithBeautifulSoup(url)
        ...
        *args[2] (result:dic([storeName] = storeAddress))
        ...
        for store in stores:
            ...
            workers.append(threading.Thread(
                target=Luca.miniworker, args=(semaphore, "https://www.iqon.jp" + store.a.get("href"), result, storeName)))
    ...
    @staticmethod
    def getStoreInfo():
        page = Luca._OpenURLWithBeautifulSoup(Luca.baseurl)
        workers = []
        result = {}
        ...
        for pref in prefs:
            workers.append(threading.Thread(
                target=Luca.prefworker, args=(semaphore, "https://www.iqon.jp" + pref.a.get("href"), result)))
        ...
        for k, v in result.items():
            Luca._AppendItemToDataFrame(k, v)

        # # 実行確認用
        # print(Luca._result_df)
        # Luca._result_df.to_csv('./Luca.csv')
        return Luca._result_df


if __name__ == "__main__":
    df = Luca.getStoreInfo()
