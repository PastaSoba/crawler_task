...
class ingni:
    baseurl = "http://www.burantasu.com/shoplist/l/172/d-all.html"
    ...
    def _AppendItemToDataFrame(storeName: str, storeAddress: str):
        ...
        tmp_se = pd.Series([storeName, storeAddress],
                           index=ingni._result_df.columns)
        ingni._result_df = ingni._result_df.append(
    ...
    @staticmethod
    def getStoreInfo():
        page = ingni._OpenURLWithBeautifulSoup(ingni.baseurl)
        ...
        for store in stores:
            ...
            ingni._AppendItemToDataFrame(storeName, storeAddress)

        # # 実行確認用
        # print(ingni._result_df)
        # ingni._result_df.to_csv('./ingni.csv')
        return ingni._result_df


if __name__ == "__main__":
    df = ingni.getStoreInfo()
